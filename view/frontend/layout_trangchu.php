	 	...
	 	<div class="container header">
	 		...
	 		<div class="row header-top">	
	 			<div class="col-lg-4 hotline">
	 				<span>	HOTLINE ĐẶT HÀNG:</span><a href="tel:0123456789">&nbsp; 0971317516</a>	
	 			</div>
           ...
           <?php }else{ ?>
	 		...
	 		<div class="main">	
	 			...
	 			<footer>
	 				<div class="container">
	 					<div class="row adr_lns">
	 						<div class="col-lg-4 adr_watch">
	 							...
	 							<div class="adr_title">
	 								<ul>
	 									...
	 									<li class="fa fa-phone" aria-hidden="true"><a href="tel:0971317516"><span>&nbsp;0123456789</span></a></li>
	 						...
	 						<div class="col-lg-4 list_product_ft">
	 							<ul>
	 								<li>Nguyễn Như Giang(18103100020)</li><br>
	 			...
	 			<div class="lns">
	 					<p>Phát triển và thiết kế bởi nhóm 7</p>
	 				</div>
	 			<!-- Back to top -->
